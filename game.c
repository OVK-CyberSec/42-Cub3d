...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/10 16:56:28 by mohifdi           #+#    #+#             */
/*   Updated: 2026/06/10 16:57:15 by mohifdi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void key_up(t_data *data, double speed)
{
    ...
    if (data->map[(int)(ny + MARGIN)][(int)(nx + MARGIN)] != '1' &&
        data->map[(int)(ny + MARGIN)][(int)(nx - MARGIN)] != '1' &&
        data->map[(int)(ny - MARGIN)][(int)(nx + MARGIN)] != '1' &&
        data->map[(int)(ny - MARGIN)][(int)(nx - MARGIN)] != '1')
    {
        data->player_x = nx;
